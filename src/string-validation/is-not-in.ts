...
// public
export default function isNotIn(values: Array<string>): ValidationRule<string>;
export default function isNotIn(values: Array<string>, ignoreCase: boolean): ValidationRule<string>;
export default function isNotIn(values: Array<string>, ignoreCase?: boolean): ValidationRule<string>
{
