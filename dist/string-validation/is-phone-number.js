...
var StringIsPhoneNumber = (function (_super) {
    __extends(StringIsPhoneNumber, _super);
    function StringIsPhoneNumber() {
        var _this = _super.call(this) || this;
        _this.addValidationRule({
            validate: function (t) { return t == null || (_this.isNumber(t) && t.trim().length === 10); },
            error: "Invalid value"
        });
        return _this;
    }
    return StringIsPhoneNumber;
